...
public class DuplicateRulesSteps {
    ...
    private DuplicateRulesPage duplicateRulesPage;
    private NewDuplicateRuleRecordPage newDuplicateRuleRecordPage;
    private DuplicateRule duplicateRule;


    @Then("^duplicate rules page is opened$")
    public void duplicateRulesPageIsOpened() {
        if (duplicateRulesPage == null) {
            duplicateRulesPage = new DuplicateRulesPage();
    ...
    public void newDuplicateRulePageIsOpened() {
        if (newDuplicateRuleRecordPage == null) {
            newDuplicateRuleRecordPage = new NewDuplicateRuleRecordPage();
        }
    ...
    public void newDuplicateRuleDetailsAreOpened() {
        if (duplicateRule == null) {
            duplicateRule = new DuplicateRule();
        }
